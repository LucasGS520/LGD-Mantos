...
O projeto é uma aplicação de gestão interna para operação, análise
...
FastAPI e cliente web responsivo em React (PWA). A IA deve ser nativa dentro desse sistema, atuando como camada auxiliar transversal,
